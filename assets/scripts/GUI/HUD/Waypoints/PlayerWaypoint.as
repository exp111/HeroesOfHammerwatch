class PlayerWaypoint : Waypoint
{
	...
	PlayerWaypoint(UnitPtr unit, PlayerRecord@ record)
	{
		...
		super(hud.m_guiDef.GetSprite("waypoint-player-head"), unit.GetPosition());
		...
		@m_spriteTexture = m_sprite.GetTexture2D();
	...
	void MakeNameText()
	{
		...
		@m_textName = m_font.BuildText(playerName);
	}
