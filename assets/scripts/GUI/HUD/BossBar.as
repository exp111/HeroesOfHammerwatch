class BossBarWidget : BarWidget
{
	...
	void Load(WidgetLoadingContext &ctx) override
	{
		...
		@m_spriteBarInvuln = def.GetSprite(ctx.GetString("bar-invuln"));
		@m_spriteBarCheckpoint = def.GetSprite(ctx.GetString("bar-checkpoint"));
	}
	...
	void UpdateAppearance()
	{
		...
		if (enemy !is null)
			SetText("" + round(m_actor.GetHealth() * enemy.GetMaxHp()));
	}
}
