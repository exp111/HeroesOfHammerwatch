...
class Widget
{
				...
				switch (m_flow)
				{
					...
					case WidgetFlow::VboxWrapped:
						...
						if (newOrigin.y < 0 || newOrigin.y - origin.y + child.m_height > m_height - m_padding.y)
						{
							...
							newOrigin.x += lastWidget.m_width + m_spacing;
						}
						break;
					...
					case WidgetFlow::HboxWrapped:
						...
						if (newOrigin.x < 0 || newOrigin.x - origin.x + child.m_width > m_width - m_padding.x)
						{
							...
							newOrigin.y += lastWidget.m_height + m_spacing;
						}
						break;
				}
			}
	...
	bool UpdateInput(GameInput& input)
	{
		return false;
	}
	...
	array<Widget@> GetWidgetsById(string id)
	{
		array<Widget@> ret;
