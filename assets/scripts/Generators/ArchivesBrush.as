class ArchivesBrush : DungeonBrush
{
	...
	void Build(Scene@ scene) override
	{
		...
		auto slime1 = Resources::GetUnitProducer("doodads/generic/deco_maggot_slime.unit");
		auto slime2 = Resources::GetUnitProducer("doodads/generic/deco_maggot_slime_v2.unit");
		auto slime3 = Resources::GetUnitProducer("doodads/generic/deco_maggot_slime_v3.unit");
		...
		for (int y = 0; y < m_height; y++)
		{
			for (int x = 0; x < m_width; x++)
			{
				...
				if (r && l)
					m_deco_books_16.Produce(scene, vec3(16 * x + m_posOffset.x + 8, 16 * y + m_posOffset.y + 16, 0));
				else if (r)
