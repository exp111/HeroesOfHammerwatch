...
class MinesGenerator : DungeonGenerator
{
	...
	void Generate(Scene@ scene) override
	{
		while (true)
		{
			...
			array<ivec2> dirs = { ivec2(0, -8), ivec2(0, 8), ivec2(-5, 0), ivec2(5, 0) };
	...
	void PlacePrefabs(PrefabPlacement@ placer)
	{
		...
		placer.PlacePrefab(PointOfInterestType::Prefab2x6Path, 2 + g_ngp);
		placer.PlacePrefab(PointOfInterestType::Prefab6x3Path, 2 + g_ngp);
		placer.PlacePrefab(PointOfInterestType::Prefab2x3Junction, 2 + g_ngp);
	}
